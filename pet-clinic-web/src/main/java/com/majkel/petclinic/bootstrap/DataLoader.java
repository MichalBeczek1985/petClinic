...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        owner2.setAddress("456 ParcelaNr4");
        owner2.setCity("Miami");
        owner2.setTelephone("56565656565");
